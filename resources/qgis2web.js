...
map.getView().fit([14520866.911603, -937379.280178, 14786760.335465, -780489.734277], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        qgis2webAttribution.innerHTML = '<a href="">3d map</a> &middot; ';
        ...
        qgisAttribution.innerHTML = '<a href="https://drive.google.com/drive/folders/1ApzbVTqs6Wp5r-8uD9jKeskBy8qgzKfW?usp=sharing">BASISDATA</a>';
